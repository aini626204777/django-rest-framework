  ...
  <div id="header" class="new_header">
    ...
    <div class="hd_main cle">
      ...
      <div class="head_search_hot">
        <span>热搜榜：</span>
        <router-link :to="'/app/home/search/' + itme.keywords" v-for="item in hotSearch" :key="item.id">{{item.keywords}}</router-link>
      </div>
      <div class="intro">
        <ul>
          <li class="no1">
...
<script>
import {getCategory, getHotSearch} from '../../api/api'
